...
<body>
    ...
    <div class="container container-main">
        ...
        <div class="container container-sub">
            ...
            <?php if ($user_role == 1): ?>
                <button type="button" class="btn btn-danger" id="rentNowBtn" style="margin-bottom:20px;" data-b
                    s-toggle="modal" data-bs-target="#rentBookModal" <?php if ($quantity == 0)
                        echo 'disabled'; ?>>Rent Now
                </button>
            <?php endif; ?>
        </div>
        <!-- Rent Book Modal -->
                ...
                <div class="modal-content">
                    ...
                    <form action="viewBook.php?view=<?php echo $view_id; ?>" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" name="borrow_book" <?php if ($quantity == 0)
                                echo 'disabled'; ?>>Borrow</button>
                        </div>
                    </form>
                </div>
            </div>
