                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item <?php echo ($current_page == 1) ? 'disabled' : ''; ?>">
                                <a class="page-link" href="<?php echo ($current_page == 1) ? '#' : 'bookCatalogue.php?page=' . ($current_page - 1); ?>">Prev</a>
                            </li>
                            <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
                                <li class="page-item <?php echo ($i == $current_page) ? 'active' : ''; ?>">
                                    <a class="page-link" href="bookCatalogue.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                </li>
                            <?php endfor; ?>
                            <li class="page-item <?php echo ($current_page == $total_pages) ? 'disabled' : ''; ?>">
                                <a class="page-link" href="<?php echo ($current_page == $total_pages) ? '#' : 'bookCatalogue.php?page=' . ($current_page + 1); ?>">Next</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><b>Genre:</b> <?php echo $row['genre']; ?><br><b>Quantity:</b> <?php echo $row['quantity']; ?></p>
                                <a href="viewBook.php?view=<?php echo $row['id']; ?>" class="btn btn-info">View</a>
                                <a href="#" class="btn btn-danger">Rent Now</a>
                            </div>
                        </div>
                    </div>
                <?php
